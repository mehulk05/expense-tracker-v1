...
export const DEFAULT_CATEGORIES: Category[] = [
  { 
    ...
    name: 'Personal', 
    type: 'personal', 
    subCategories: ['Food', 'Rent', 'Travel', 'Clothing', 'Entertainment'] 
  },
  { 
    id: '2', 
    name: 'Utilities', 
    type: 'other', 
    subCategories: ['Insurance', 'Mobile Recharge', 'Electricity', 'Internet'] 
  },
  { 
    id: '3', 
    name: 'Investment', 
...
export const ICONS = {
  ...
  Expense: (props: any) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2v20"/><path d="m17 5-5-3-5 3"/><path d="m17 19-5 3-5-3"/><rect width="18" height="14" x="3" y="5" rx="2"/></svg>
  ),
  Account: (props: any) => (
  ...
  Lightbulb: (props: any) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="9" x2="15" y1="19" y2="19"/><line x1="10" x2="14" y1="22" y2="22"/><path d="M15.09 14c.18-.9.27-1.48.33-1.92.19-1.37.27-2.75-.43-3.67A4.5 4.5 0 0 0 8.02 6.5c-.8.8-.93 1.95-.97 3.03a11.16 11.16 0 0 0 .54 3.78c.37 1.25.99 2.1 1.48 2.69a2 2 0 0 1 .93 2Z"/><line x1="12" x2="12" y1="2" y2="4"/><line x1="4.22" x2="5.64" y1="4.22" y2="5.64"/><line x1="18.36" x2="19.78" y1="4.22" y2="5.64"/><line x1="1" x2="3" y1="12" y2="12"/><line x1="21" x2="23" y1="12" y2="12"/></svg>
  ),
  ...
  FileStack: (props: any) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 22h14a2 2 0 0 0 2-2V7.5L14.5 2H6a2 2 0 0 0-2 2v4"/><polyline points="14 2 14 8 20 8"/><path d="M2 15h10"/><path d="m9 18 3-3-3-3"/></svg>
  ),
  Sparkles: (props: any) => (
  ...
  Bot: (props: any) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="18" height="10" x="3" y="11" rx="2"/><circle cx="12" cy="5" r="2"/><path d="M12 7v4"/><line x1="8" x2="8" y1="16" y2="16"/><line x1="16" x2="16" y1="16" y2="16"/></svg>
  ),
  Document: (props: any) => (
  ...
  History: (props: any) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 8v4l3 3"/><circle cx="12" cy="12" r="9"/><path d="M3.05 11a9 9 0 1 1 .5 4m-.5 5v-5h5"/></svg>
  ),
